...
STABLE_DOCKER_REGISTRY ${KUBE_DOCKER_REGISTRY:-ghcr.io/freefair/cluster-api-provider-hcloud}
STABLE_DOCKER_PUSH_REGISTRY ${KUBE_DOCKER_PUSH_REGISTRY:-${KUBE_DOCKER_REGISTRY:-ghcr.io/freefair/cluster-api-provider-hcloud}}
